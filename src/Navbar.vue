<template>
  ...
  <a class="navbar-brand" href="#/">Soru/Anket</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#/questions2">Yazılım</a>
          <a class="dropdown-item" href="#/questions3">Dizi/Film</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link disabled" href="#">Ödeme Şartları</a>
      </li>
    </ul>
